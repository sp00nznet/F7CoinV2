...
- If you are running v0.8.7.4 as distributed by f7coin.org you do not need to upgrade.
  The binaries distributed on f7coin.org contain their own copy of openssl so they are unaffected by this issue.
