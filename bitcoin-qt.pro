...
macx:ICON = src/qt/res/icons/f7coin.icns
...
LIBS += -lssl -lcrypto -ldb_cxx$$BDB_LIB_SUFFIX -l boost_chrono$(BOOST_SUFFIX) boost_thread$(BOOST_SUFFIX) -l boost_program_options$(BOOST_SUFFIX) 
